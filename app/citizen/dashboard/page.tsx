        ...
        <main className="flex-1 max-w-[1200px] mx-auto w-full px-4 md:px-6 py-6 md:py-10">
          ...
          <section className="mb-6 md:mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-slate-500 mt-1 max-w-md">Your centralized portal for submitting arzis and service requests. Ensuring transparency and accountability.</p>
            </div>
          ...
          <section className="space-y-6">
            ...
            <div className="bg-white rounded border border-slate-200 overflow-hidden shadow-sm">
              {fetching ? (
                ...
                <div className="p-16 text-center">
                  ...
                  <p className="font-bold text-slate-500">No arzis filed yet</p>
                  <p className="text-sm text-slate-400 mt-1">Submit your first arzi using the button above.</p>
                  <Link href="/citizen/submit">
            ...
            <div className="bg-gov-navy/5 border border-gov-navy/10 p-5 rounded flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600">Your arzi is protected by end-to-end encryption. Each submission is tracked by a unique Arzi ID for legal compliance.</p>
              </div>
            </div>
          </section>
        </main>
