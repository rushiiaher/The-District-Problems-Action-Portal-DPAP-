      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <header className="h-14 flex items-center justify-between px-4 md:px-8 bg-gov-navy text-white sticky top-0 z-10 flex-shrink-0">
          <div className="flex items-center gap-2">
            <SidebarToggle />
            <Link href="/admin/complaints" className="text-slate-400 hover:text-white transition-colors">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 text-slate-400 gap-3">
            ...
            <Link href="/admin/complaints">
              <button className="px-4 py-2 bg-gov-navy text-white text-sm font-bold rounded">Back to Registry</button>
            </Link>
          </div>
        ) : (
                  ...
                  <div className="grid sm:grid-cols-2 gap-4 border-t border-slate-100 pt-4">
                    ...
                    {complaint.priority && (
                      <div>
                        ...
                        <p className={`text-sm font-bold ${complaint.priority === "HIGH" ? "text-red-600" : complaint.priority === "MEDIUM" ? "text-amber-600" : "text-slate-600"}`}>
                          {complaint.priority}
                        </p>
                      </div>
                    )}
                      ...
                      return (
                        <div key={t.id || i} className="flex items-start gap-3">
                          ...
                          <div className="flex-1 pb-3">
                            ...
                            {t.remarks && (
                              <p className="text-xs text-slate-600 mt-1.5 leading-relaxed bg-slate-50 rounded px-3 py-2">{t.remarks}</p>
                            )}
                          </div>
                        </div>
                      )
